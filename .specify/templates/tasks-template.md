...
**Tests**: Tests are mandatory for behavior changes. Use Red-Green TDD: write or
update failing tests first, run the narrowest practical command to prove RED,
implement the minimal change for GREEN, then refactor with tests passing. Omit
test tasks only for documentation-only or mechanical metadata changes and record
the exception.
...
### RED Tests for User Story 1 (mandatory for behavior changes) ⚠️

> **NOTE: Write these tests FIRST and run the listed command to confirm RED before implementation.**

- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [US1] Run RED test command and record the expected failure
...
- [ ] T019 [US1] Run GREEN test command and record passing result
...
### RED Tests for User Story 2 (mandatory for behavior changes) ⚠️
...
- [ ] T022 [US2] Run RED test command and record the expected failure
...
- [ ] T027 [US2] Run GREEN test command and record passing result
...
### RED Tests for User Story 3 (mandatory for behavior changes) ⚠️
...
- [ ] T030 [US3] Run RED test command and record the expected failure
...
- [ ] T034 [US3] Run GREEN test command and record passing result
...
- [ ] TXXX [P] Additional regression or edge-case tests in tests/unit/
...
- Refactoring MUST keep the relevant tests passing
...
- All RED tests for a user story marked [P] can run in parallel
...
- Verify RED tests fail before implementing
- Verify GREEN tests pass after implementation and again after refactoring
